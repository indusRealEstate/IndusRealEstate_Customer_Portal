...
if (isset($postdata) && !empty($postdata)) {
    ...
    $data_2 = $dbase->execute("SELECT * FROM payment_requests pr, user u, user_details ud WHERE pr.user_id = u.id AND pr.user_id = ud.user_id AND u.id = '{$decodedData["userId"]}'");
