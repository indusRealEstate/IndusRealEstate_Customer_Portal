...
if (isset($postdata) && !empty($postdata)) {
    ...
    if ($result->num_rows != 0) {
        ...
        if ($userDecoded[0]->auth_type == 'admin') {
            ...
            // $sample_array = array();
            $data_1 = $dbase->execute("SELECT * FROM user_documents udoc, user u, user_details ud, user_properties usp WHERE udoc.user_id = u.id AND udoc.user_id = ud.user_id AND udoc.property_id = usp.property_id");
