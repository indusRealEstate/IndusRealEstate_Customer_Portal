...
export class FM_MaintananceRequest implements OnInit {
  @ViewChild(FM_MaintananceRequest_Stepper_First) oneComponent: FM_MaintananceRequest_Stepper_First;
  @ViewChild(FM_MaintananceRequest_Stepper_Second) twoComponent: FM_MaintananceRequest_Stepper_Second;
  @ViewChild(FM_MaintananceRequest_Stepper_Third) threeComponent: FM_MaintananceRequest_Stepper_Third;
  @ViewChild(FM_MaintananceRequest_Stepper_Fourth) fourComponent: FM_MaintananceRequest_Stepper_Fourth;
  @ViewChild(FM_MaintananceRequest_Stepper_Fifth) fiveComponent: FM_MaintananceRequest_Stepper_Fifth;
  @ViewChild(FM_MaintananceRequest_Stepper_Sixth) sixComponent: FM_MaintananceRequest_Stepper_Sixth;
