...
export class Tenant_Registration implements OnInit {
  @ViewChild(Tenant_Registration_Stepper_First)
  oneComponent: Tenant_Registration_Stepper_First;
  @ViewChild(Tenant_Registration_Stepper_Second)
  twoComponent: Tenant_Registration_Stepper_Second;
  @ViewChild(Tenant_Registration_Stepper_Third)
  threeComponent: Tenant_Registration_Stepper_Third;
  @ViewChild(Tenant_Registration_Stepper_Fourth)
  fourComponent: Tenant_Registration_Stepper_Fourth;
  @ViewChild(Tenant_Registration_Stepper_Fifth)
  fiveComponent: Tenant_Registration_Stepper_Fifth;
  @ViewChild(Tenant_Registration_Stepper_Sixth)
  sixComponent: Tenant_Registration_Stepper_Sixth;
