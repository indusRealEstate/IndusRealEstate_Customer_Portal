...
export class Tenant_Move_out_Request implements OnInit {
  @ViewChild(Tenant_Move_out_Request_Stepper_First)
  oneComponent: Tenant_Move_out_Request_Stepper_First;
  @ViewChild(Tenant_Move_out_Request_Stepper_Second)
  twoComponent: Tenant_Move_out_Request_Stepper_Second;
  @ViewChild(Tenant_Move_out_Request_Stepper_Third)
  threeComponent: Tenant_Move_out_Request_Stepper_Third;
  @ViewChild(Tenant_Move_out_Request_Stepper_Fourth)
  fourComponent: Tenant_Move_out_Request_Stepper_Fourth;
  @ViewChild(Tenant_Move_out_Request_Stepper_Fifth)
  fiveComponent: Tenant_Move_out_Request_Stepper_Fifth;
  @ViewChild(Tenant_Move_out_Request_Stepper_Sixth)
  sixComponent: Tenant_Move_out_Request_Stepper_Sixth;
