...
@Component({
  selector: "stepper-one-tenant-reg",
  styleUrls: ["./stepper_first_reg_tenant.scss"],
  templateUrl: "./stepper_first_reg_tenant.html",
})
export class StepperTenantRegisterFirst {
  form: FormGroup;
  passportExpiry: any;
  selectedCountry: any;
