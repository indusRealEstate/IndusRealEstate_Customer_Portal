 ...
 */
@Component({
  selector: "landlord-requests-dropdown",
  templateUrl: "./landlord-requests-dropdown.html",
  styleUrls: ["./landlord-requests-dropdown.scss"],
})
export class LandlordRequestsDropdown implements OnInit {
  userId: any;
  ...
  navigateToRequests(req) {
    ...
    } else if (req == "inspection") {
      this.router.navigate(["/inspection-requests"], {
        queryParams: { uid: this.userId },
      });
    }
